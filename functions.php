      ...
      foreach ($pc['service_reference'] as $p) {
        if ($p['value'] == $post->post_name) {
          ...
          if ($a['return'] == 'featured_image') {
            ...
            $ret = '';
			              // $ret .= '<div class="frame" style="background-image: url('.$pc['service_image']['url'].')"></div>';

            $ret .= '<h2>'.$pc['service_title'].'</h2>';
...
function featured_services( $atts, $content = null )
{
  ...
  if ($page_content = get_field('service', 'option')) {
    ...
    foreach ($page_content as $pc) {
      if (($pc['service_type'] == $a['service_type']) && ($pc['featured_service'])) {
        $ret .= '<div class="featured__item">';
          $ret .= '<div class="featured__frame" style="background-image: url('.$pc['service_image']['sizes']['medium'].')">';
    ...
    return '<div class="featured"><div class="featured__item"><div class="featured__frame" style="background-image: url(https://rightcl.com/wp-content/uploads/2021/07/Bridge-Loans-Hard-Money-bottom-links-scaled.jpg)"></div><a href="/financial-service/fix-and-flip-financing/" class="btn">Bridge and Hard Money Loans</a></div><div class="featured__item"><div class="featured__frame" style="background-image: url(https://rightcl.com/wp-content/uploads/2021/07/Business-Loans-bottom-links-scaled.jpg)"></div><a href="/financial-service/small-business-loan" class="btn">Business Loan</a></div><div class="featured__item"><div class="featured__frame" style="background-image: url(https://rightcl.com/wp-content/uploads/2021/07/Working-Capital-bottom-links-scaled.jpg)"></div><a href="/financial-service/unsecured-business-lines-of-credit" class="btn">Working Capital</a></div></div>
<a href="/financial-service" class="btn btn--center">See All Services</a>';
  }
